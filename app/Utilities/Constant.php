...
class Constant
{
        //Hang so su dung chung he thong
    ...
    public static $order_status = [
        ...
        self::order_status_Unconfirmed =>' Unconfirm',
        self::order_status_Confirmed => 'Confirm',
