        ...
        <div class="fw-color-choose">
            ...
            <div class="cs-item">
                <input type="radio" id="cs-green" name="color" value="green" onchange="this.form.submit();"
                    {{request('color')== 'green font-weight-bold' ? 'checked' : ''}}>
