                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                            <div class="product-details">
                                ...
                                <div class="pd-color">
                                    ...
                                    <div class="pd-color-choose">
                                        @foreach(array_unique(array_column($product->productDetails->toArray(),'color')) as $productColor)
                                                ...
                                                <div class="cc-item">
                                                    <input id="cc-{{$productColor}}" type="radio">
                                ...
                                <div class="pd-size-choose">
                                    @foreach(array_unique(array_column($product->productDetails->toArray(),'size')) as $productSize)
                                        <div class="sc-item">
                                            ...
                                            <label id="getSize" for="sm-{{$productSize}}" value="{{$productSize}}">{{$productSize}} </label>
                                        </div>
                                    @endforeach
                                ...
                                <div class="quantity">
                                    <div class="pro-qty">
                                        <input id="qty_in_show" type="text" value="1" >
                                    </div>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    @foreach(array_unique(array_column($product->productDetails->toArray(),'color')) as $productColor)
                                                            ...
                                                            <span>  {{strtoupper($productColor)}} , </span>
