                        ...
                        <div class="col-md-12">
                            <div class="main-card mb-3 card">
                                <div class="card-body display_data">
                                    ...
                                    <div class="position-relative row form-group">
                                        <label for="brand_id"
                                            class="col-md-3 text-md-right col-form-label">Edit</label>
                                        <div class="col-md-9 col-xl-8">
                                            <p><a href="./admin/product/{{$product->id}}/edit">Edit Detail Product</a></p>
                                            <p><a href="./admin/product/{{$product->id}}/image">Edit Image Product</a></p>
                                        </div>
                                    </div>
                                    ...
                                    <div class="position-relative row form-group">
                                        <label for="qty"
                                            class="col-md-3 text-md-right col-form-label">Size / Qty</label>
                                        <div class="col-md-9 col-xl-8">
