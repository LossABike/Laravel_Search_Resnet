                                    ...
                                    <table class="align-middle mb-0 table table-borderless table-striped table-hover">
                                        ...
                                        @foreach($products as $product)
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center">{{$product->qty> 0 ? 'available' : 'hide'}}</td>
                                                ...
                                                <td class="text-center">
                                                    ...
                                                    <form class="d-inline" action="./admin/product/{{$product->id}}" method="post">
                                                        ...
                                                        <button class="btn btn-hover-shine btn-outline-danger border-0 btn-sm"
                                                            type="submit" data-toggle="tooltip" title="Hide"
                                                            data-placement="bottom"
                                                            onclick="return confirm('Do you really want to hide this item?')">
                                                            <span class="btn-icon-wrapper opacity-8">
