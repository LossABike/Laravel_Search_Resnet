                                       ...
                                       @csrf
                                        ...
                                        <div class="position-relative row form-group">
                                            ...
                                            <div class="col-md-9 col-xl-8">
                                                <img style="height: 200px; cursor: pointer;"
                                                     ...
                                                     src="front/img/products/{{$product->productImages[0]->path}}" alt="Avatar">
                                        ...
                                        <div class="position-relative row form-group">
                                            ...
                                            <div class="col-md-9 col-xl-8">
                                                <input required name="color" id="color" placeholder="Color" type="text"
                                                       class="form-control" value="{{$productDetails[0]->color ?? ''}}">
                                            </div>
                                        </div>
                                        <div class="position-relative row form-group">
                                            <label for="cr" class="col-md-3 text-md-right col-form-label">Current Size/Qty</label>
                                            <div class="col-md-9 col-xl-8">

                                                @foreach($productDetails as $productDetail)
                                                   <span class="col-md-5" class="form-control" >
                                                       [ {{$productDetail->size}}*{{$productDetail->qty}} ]
                                                   </span>
                                                @endforeach
                                            </div>
                                        </div>
                                        ...
                                        <div class="position-relative row form-group">
                                            ...
                                            <span class="col-md-1">
                                                ...
                                                <input  name="sizeS" id="size" placeholder="Qty S" type="number"
                                            ...
                                            <span class="col-md-1">
                                                ...
                                                <input  name="sizeXS" id="size" placeholder="Qty XS" type="number"
                                                       class="form-control" value="-1">
                                            </span>
                                            <span class="col-md-1">
                                                <input disabled  type="text"
                                                ...
                                                <input  name="sizeM" id="size" placeholder="Qty M" type="number"
                                                       class="form-control" value="-1">
                                            </span>
                                            <span class="col-md-1">
                                                <input disabled  type="text"
                                                ...
                                                <input  name="sizeL" id="size" placeholder="Qty L" type="number"
                                                       class="form-control" value="-1">
                                            </span>
                                            <span class="col-md-1">
                                                <input disabled  type="text"
                                                ...
                                                <input  name="sizeXL" id="size" placeholder="Qty XL" type="number"
                                                       class="form-control" value="-1">
                                            </span>
                                        </div>
